    ...
    render() {
        return (
            ...
            {/* <div className="bg-gray-200 md:py-20 lg:py-56 h-screen" style={{ backgroundImage: `url(${x1})`, backgroundPosition: "center", backgroundRepeat: "no-repeat", backgroundSize: "contain" }}> */}
                ...
                <div class="container xl:px-40 px-10 mx-auto py-8 md:py-16 lg:py-24 xl:py-32">
                    ...
                    <p className="xl:-mt-8 xl:text-lg py-16 uppercase font-extrabold text-xs">Review the entire offer</p>
                </div>
            </div>
            </div>
        )
